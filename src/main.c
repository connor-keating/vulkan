...
internal HWND window_init(HINSTANCE currentInstanceHandle, int displayFlags)
{
    i32 window_x = 50;
    i32 window_y = 90;
    i32 window_w = 50;
    ...
    ShowWindow(window_handle, displayFlags);
...
int main(int argc, char **argv) 
{
	...
	/*
		1) Initialise window
		   Handles OS-specific interfaces such as creating and accessing a window and gathering input.
	*/
	HINSTANCE current_instance_handle = GetModuleHandleA(0);
    HWND window_handle = window_init(current_instance_handle, SW_SHOW);
	...
	*/
	// TODO: Use windows surface
	VkSurfaceKHR surface;
    VkWin32SurfaceCreateInfoKHR createInfo = {0};
    createInfo.sType = VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR;
    createInfo.hinstance = current_instance_handle;
